# Project 1 Documentation EGR 115
import math
...
while loop1:
    ...
    if "ca" in mat.casefold() or '1' in mat.casefold():
        ...
        if 0.5 <= legnth <= 10:
            ...
            if account <= 0:
                matreset()
                account, weight = matreset[1], matreset[0]
            ...
            legreset()
            weight, account = legreset[0], legreset[1]

    elif "pv" in mat.casefold() or '2' in mat.casefold():
    ...
    elif "st" in mat.casefold() or '3' in mat.casefold():
        ...
        if 0.5 <= legnth <= 10:
            ...
            legreset()
            weight, account = legreset(), legreset[1]
...
plt.xlim(0, burntime*1.05)
plt.ylim(0, position1/2 * 1.1)
plt.minorticks_on()
plt.ylim(bottom=0)
plt.show()
